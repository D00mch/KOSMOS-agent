...
Когда мы описывали функции в примерах выше, мы думали о том, как объяснить ее чату и какое имя ей дать. Так что нам понадобятся имя, описание и сама функция:
```kotlin
